...
```
This function is available in rcpptimer you can try it yourself, e.g.  `rcpptimer::fibonacci(n = rep(15:20, 10))`. After that you can observe the timings by executing `print(times)`.
